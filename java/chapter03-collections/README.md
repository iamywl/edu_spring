...
> 이 문서는 **실습 가이드**입니다. 개념 설명은 [JAVA_개념서](../docs/JAVA_교재/심화/README.md)와 [JAVA_교육자료](../docs/JAVA_교육자료.md)를 참고하세요.
...
```bash
cd java && docker compose up -d   # java-sandbox 컨테이너 켜기 (이미 떠 있으면 생략)
...
> 각 개념은 이제 독립 실행 스크립트로 분리되어 있습니다(**개념당 스크립트 1개**). 소스 파일을 수정한 후 `./compile.sh` → `./run.sh <ClassName>`으로 바로 결과를 확인하세요. 인자 없이 `./run.sh`를 실행하면 대화형 메뉴에서 카테고리(Chapter 03)를 고른 뒤 개념을 선택할 수 있습니다. 처음이라면 [java/README.md](../README.md)의 "빠른 시작"을 먼저 보라.
...
**개념 학습**
- 📖 [JAVA_개념서](../docs/JAVA_교재/심화/README.md) - Chapter 5: "제네릭" 읽기
...
**개념 학습**
- 📖 [JAVA_개념서](../docs/JAVA_교재/심화/README.md) - Chapter 5: "컬렉션 - 배열의 한계, List/Set/Map, HashMap 내부 구조" 읽기
...
**개념 학습**
- 📖 [JAVA_개념서](../docs/JAVA_교재/심화/README.md) - Chapter 6: "함수형 프로그래밍 - Stream (컨베이어 벨트 비유)" 읽기
...
**개념 학습**
- 📖 [JAVA_개념서](../docs/JAVA_교재/심화/README.md) - Chapter 6: "람다 표현식" 읽기
